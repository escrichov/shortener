...
urlpatterns = [
    ...
    path('upgrade_to_premium', backend.upgrade_to_premium, name='upgrade_to_premium'),
    path('create_api_access', backend.create_api_access, name='create_api_access'),
    path('delete_api_access/<int:api_access_id>', backend.delete_api_access, name='delete_api_access'),

    # API
    path('api/url/create', api.api_url_create, name='api_create_url'),
    path('api/url/delete/<slug:uid>', api.api_url_delete, name='api_delete_url'),
